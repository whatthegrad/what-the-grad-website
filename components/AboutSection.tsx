...
export default function AboutSection() {
  ...
  return (
    <section id="about" ref={sectionRef} style={{ background:'#D6E8F5', minHeight:'100vh', padding:'80px 5vw 100px', position:'relative', overflow:'hidden', transform:`translateY(${Math.max(0,60-progress*60)}px)`, opacity:Math.min(1,progress*1.4) }}>
      <style>{`@import url('https://fonts.googleapis.com/css2?family=Dancing+Script:wght@600;700&display=swap');`}</style>
      <svg style={{ position:'absolute', inset:0, width:'100%', height:'100%', opacity:0.25, pointerEvents:'none' }} viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
      ...
      <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:'40px', maxWidth:'1200px', margin:'0 auto', alignItems:'start', position:'relative', zIndex:2 }}>
        ...
        <div style={{ opacity:Math.min(1,(progress-0.35)*2.5), transform:`translateY(${Math.max(0,28-progress*45)}px)` }}>
          ...
          <p style={{ fontFamily:PD, fontSize:'15px', color:'#5C4A3A', lineHeight:'1.8', marginBottom:'14px' }}>
          ...
          <p style={{ fontFamily:PD, fontSize:'15px', color:'#5C4A3A', lineHeight:'1.8', marginBottom:'20px' }}>
          ...
          <p style={{ fontFamily:PD, fontSize:'15px', color:'#5C4A3A', lineHeight:'1.8', marginBottom:'20px' }}>
            No aptitude tests that tell you &quot;you should be an engineer.&quot; No templated advice. No jargon. Just the right questions, asked by people who&apos;ve been there.
          </p>

          <h3 style={{ fontFamily:PD, fontSize:'16px', fontWeight:'700', color:'#2C1810', marginBottom:'10px' }}>Why we&apos;re different</h3>
          <p style={{ fontFamily:PD, fontSize:'15px', color:'#5C4A3A', lineHeight:'1.8', marginBottom:'14px' }}>
            We&apos;re not a coaching class. Not a test prep company. Not a college admission agency. We&apos;re the people you talk to <em>before</em> all of those.
          </p>
          <p style={{ fontFamily:PD, fontSize:'15px', color:'#5C4A3A', lineHeight:'1.8', marginBottom:'20px' }}>
            9 out of 10 Indian students make career decisions with zero guidance. We&apos;re here for the ones who&apos;d rather not.
          </p>
          ...
          <div style={{ marginTop:'28px', padding:'20px 24px', background:'rgba(255,255,255,0.6)', borderRadius:'16px', borderLeft:'3px solid #F5A623' }}>
            <p style={{ fontFamily:PD, fontSize:'16px', fontWeight:'700', color:'#2C1810', marginBottom:'4px', fontStyle:'italic' }}>
              Slide into our DMs.
            </p>
            <p style={{ fontFamily:PD, fontSize:'14px', color:'#5C4A3A', lineHeight:'1.7' }}>
              We&apos;ll help you figure out what&apos;s next. Promise.
            </p>
          </div>
          ...
          <div style={{ marginTop:'32px', display:'flex', gap:'40px', alignItems:'flex-start' }}>
            <div>
              <p style={{ fontFamily:DS, fontSize:'26px', fontWeight:'700', color:'#2C1810', lineHeight:1.2 }}>Sakshi More</p>
              <p style={{ fontFamily:PD, fontSize:'12px', color:'#9B8B7A', letterSpacing:'0.05em', marginTop:'2px' }}>Co-founder</p>
            </div>
            <div>
              <p style={{ fontFamily:DS, fontSize:'26px', fontWeight:'700', color:'#2C1810', lineHeight:1.2 }}>Nupoor Deore-Katare</p>
              <p style={{ fontFamily:PD, fontSize:'12px', color:'#9B8B7A', letterSpacing:'0.05em', marginTop:'2px' }}>Co-founder</p>
            </div>
          </div>
        </div>
